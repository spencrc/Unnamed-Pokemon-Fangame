...
function Overworld:load(SM)
    local instance = setmetatable({}, Overworld)

    instance.SM = SM
    instance.map_layer1, instance.map_layer2 = love.filesystem.load("maps/test-map.lua", "b")()
    instance.tileset = love.graphics.newImage("assets/images/collision-showcase.png")
    instance.player_tileset = love.graphics.newImage("assets/images/temp-player.png")
    instance.quads = {}
    instance.player = {
